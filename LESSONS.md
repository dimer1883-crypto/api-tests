...
- [ ] Урок 2. POST-запрос: создание ресурса и проверка ответа сервера
- [ ] Урок 3. Фикстуры pytest и базовый URL (session-scoped)
...
- [ ] Дальше по договорённости: CI (GitHub Actions), Allure, переход на публичный реальный API (GitHub REST)
